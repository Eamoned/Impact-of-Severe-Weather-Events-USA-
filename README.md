This document was completed entirely in a single R markdown document and transformed into a HTML document using Knitr, a tool to create reproducible documents from R coding.
